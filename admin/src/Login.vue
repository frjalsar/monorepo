...
console.log(import.meta.env.RENDER_EXTERNAL_URL)
console.log(import.meta.env.RENDER_GIT_BRANCH)
console.log(import.meta.env.RENDER_SERVICE_ID)
console.log(import.meta.env.RENDER_SERVICE_NAME)
